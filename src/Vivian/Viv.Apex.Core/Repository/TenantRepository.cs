...
namespace Viv.Apex.Core.Repository
{
    ...
    {
        public TenantRepository(IVivContext context, IMomoDbContext dbContext, IRedisService redisService, IDistributedLock distributedLock, ILoggerContract logger)
