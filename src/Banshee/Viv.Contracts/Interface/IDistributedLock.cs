...
namespace Viv.Contracts.Interface
{
    ...
    public interface IDistributedLock
    {
        ...
        Task<bool> IsLockHeldAsync(object key);
        ...
        Task<bool> ReleaseLockAsync(object key, string? lockHolderId = null, bool isReentrant = false);
        ...
        /// </remarks>
        Task<bool> AcquireLockWithRetryAsync(object key, TimeSpan expire, string? lockHolderId = null, bool isReentrant = false, int maxRetryCount = 5, int baseDelay = 200, int maxDelay = 5000, CancellationToken cancellationToken = default);
